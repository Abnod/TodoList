...
<div class="container">
    ...
    <div class="header">
        ...
        <div class="menu">
            <a href="${mainListUrl}">All tasks</a>
            <div class="whiteline"></div>
            <a href="${doneListUrl}" class="active">Completed tasks</a>
            <div class="whiteline"></div>
    ...
    <div class="task_table">
        ...
        <div class="task_block">
            <c:forEach items="${tasks}" var="task">
                <c:url var="setDoneUrl" value="/complete_task?id=${task.id}&page=${page}&sr=co" />
                <c:url var="editUrl" value="/edit_task?id=${task.id}&page=${page}&sr=co" />
                <c:url var="deleteUrl" value="/delete_task?id=${task.id}&page=${page}&sr=co" />
                <div class="task_row">
